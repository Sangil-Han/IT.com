...
<body>
	<h1 align="center">${lectureBoard.lBoardNo}번 게시글 상세 보기</h1>
	<br><br>
	<table align="center" width="500" border="1">
		...
		<tr height="300">
			<td>내용</td>
			<td>${lectureBoard.lBoardContents }
			</td>
		</tr>
		<tr>
			<td>조회수</td>
		...
		<tr>
			<td>첨부파일</td>
			<td>
				<img alt="본문이미지" src="/resources/buploadFiles/${lectureBoard.lBoardFileRename }" 
				width="300" height="300">
			</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<a href="/lecture/modifyView.do?lBoardNo=${lectureBoard.lBoardNo}&page=${page}">수정 페이지로 이동</a>
			</td>
		</tr>
	</table>
	<%-- <!-- 	댓글 등록 -->
