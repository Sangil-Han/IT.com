...
<%-- 			<td><a href="/consult/consultDetailView.do?cBoardNo=${cBoard.cBoardNo }&page=${currentPage}">${cBoard.cBoardTitle }</a></td> --%>
				<td><a href="#" onclick="detailView('${userId}', ${cBoard.cBoardNo },${currentPage });">${cBoard.cBoardTitle }</a></td>
		...
		function detailView(userId, cBoardNo, currentPage ) {
			if(userId == "") {
				if(confirm("로그인이 필요한 서비스입니다. 로그인하시겠습니까?")){
					location.href='http://127.0.0.1:8888/user/loginView.do';
				}
			}else{
				location.href='http://127.0.0.1:8888/consult/consultDetailView.do?cBoardNo='+cBoardNo+'&page='+currentPage;
			}
		}
	</script>
</body>
